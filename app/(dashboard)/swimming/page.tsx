...
export default function SwimmingPage() {
  ...
  return (
    <SportGuard requiredSport="Swimming">
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent-sky to-accent-sky/60 flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted">{user.name} Ettinger &bull; LAC-NT Swim Team</p>
          </div>
        </div>
