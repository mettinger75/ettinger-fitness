...
export function UserSelector() {
  ...
  const { activeUserId, setActiveUser, getActiveUser } = useUserStore();
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-bg-card-hover transition-colors"
      >
        <div
